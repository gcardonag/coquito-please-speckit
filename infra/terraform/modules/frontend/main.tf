resource "aws_s3_bucket" "main" {
  bucket = "coquito-please-frontend-${terraform.workspace == "default" ? "prod" : terraform.workspace}"
}
...
resource "aws_cloudfront_origin_access_control" "main" {
  name                              = "coquito-frontend-oac"
  description                       = "OAC for Coquito Please frontend S3 bucket"
